...
class Sticker(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        h = int(movie.frameRect().size().width() * self.size)
...
if __name__ == '__main__':
    ...
    s = Sticker('gif/left.gif', xy=[-80, 100], on_top=False)

    s1 = Sticker('gif/amongus/red_vent.gif', xy=[780, 920], size=0.3, on_top=True)

    s2 = Sticker('gif/amongus/orange.gif', xy=[1200, 820], size=0.3, on_top=True)
